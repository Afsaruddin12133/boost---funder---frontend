      ...
      <div className="grid lg:grid-cols-[minmax(0,1fr)_360px] gap-6">
        <div className="space-y-6">
          ...
          <div className="space-y-3">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              {renderSection("Revenue", revenue, false, (value) =>
                typeof value === "number" ? formatCurrency(value) : value
              )}
              {renderSection("Team", team, false, renderTeam)}
              {renderSection("Use of Funds", useOfFunds, false, renderUseOfFunds)}
              {renderSection("Analytics Metrics", revenueMetrics, false, renderMetrics)}
            </div>
          </div>
