...
// `SubscriptionPage.orig.jsx`.
// ---------------------------------------------------------------------
// Backup of original SubscriptionPage.jsx - preserved before temporary commenting.
...
// Active placeholder shown to users while the subscription flow is disabled.
export default function SubscriptionPage() {
  return (
    <div className="w-full min-h-[60vh] flex items-center justify-center p-6">
      <div className="max-w-xl w-full text-center bg-white/[0.03] border border-white/5 rounded-2xl p-10">
        <h2 className="text-3xl font-black text-white mb-2">Subscription Coming Soon</h2>
        <p className="text-white/60">We have temporarily disabled subscription management. All features are available for free — enjoy full access.</p>
      </div>
    </div>
  );
}
